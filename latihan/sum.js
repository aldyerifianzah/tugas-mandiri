...
function sumTheNumber(stringNumber) {
    ...
    var indexgenap = []
    var indexganjil = []
    //car index ganjil dan genap
    for (let i = 0; i < stringNumber.length; i++) {
        if (i % 2 == 0) {
            indexgenap.push(stringNumber[i] * 1)
        } else {

            indexganjil.push(stringNumber[i] * 2)
        }

    }
    // console.log(indexgenap)
    // console.log(indexganjil)
    ...
    var total1 = 0
    for (let j = 0; j < indexganjil.length; j++) {
        total1 += indexganjil[j]
